...
class Constants {
  ...
  static TextStyle getTitleTextStyle() {
    return TextStyle(
        color: Colors.white, fontWeight: FontWeight.bold, fontSize: _caculateFontSize(48));
  }

  static TextStyle getPokemonTitleTextStyle() {
    return TextStyle(
        color: Colors.white, fontWeight: FontWeight.bold, fontSize: _caculateFontSize(22));
  }
